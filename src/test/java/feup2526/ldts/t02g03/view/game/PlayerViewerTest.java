...
class PlayerViewerTest {
    ...
    @Test
    void testDrawDeadCollisionBlinking() {
        Player mockPlayer = Mockito.mock(Player.class);
        GUI mockGUI = Mockito.mock(GUI.class);
        GUIImage mockImage = Mockito.mock(GUIImage.class);
        ...
        collisionTime = System.currentTimeMillis() - 250;
        viewer.draw(mockGUI, mockPlayer, 16, 50, true, collisionTime);
        assertEquals("docs/images/sprites/chickenLeft.png", viewer.getLastRequestedPath());
    }

    //Exact same as before, other direction
    @Test
    void testDrawDeadCollisionRightDirection() {
        Player mockPlayer = Mockito.mock(Player.class);
        GUI mockGUI = Mockito.mock(GUI.class);
        GUIImage mockImage = Mockito.mock(GUIImage.class);
        ...
        long collisionTime = System.currentTimeMillis();
        viewer.draw(mockGUI, mockPlayer, 16, 50, true, collisionTime);
        assertEquals("docs/images/sprites/chickenRightDead.png", viewer.getLastRequestedPath());
